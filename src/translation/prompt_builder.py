...
def build_translation_prompt(
    ...
    instructions = [
        ...
        "- STRICT ENGLISH ONLY: Return ONLY English translations in the 'english' field. Never output Japanese characters (Kanji, Hiragana, Katakana) in the 'english' field.",
        "- UNTRANSLATABLE / SILENCE: If an item cannot be translated, is garbled, or represents silence (e.g. dots, marks), return '' (empty string) in the 'english' field. Never invent dialogue or copy text from adjacent speech bubbles.",
